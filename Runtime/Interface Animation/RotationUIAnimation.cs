...
namespace VaporStateMachine.Interface
{
    public class RotationUIAnimation : BaseUIAnimation
    {
        ...
        public RotationUIAnimation(RectTransform target, float duration, int iterations, Vector3 delta, Easing.Ease ease = Easing.Ease.Linear) : base(duration, iterations, ease, false)
        {
            _target = target;
            _delta = delta;
        }
